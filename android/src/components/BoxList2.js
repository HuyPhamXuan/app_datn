...
export default class BoxList2 extends Component{
    constructor(props){
        super(props)
    }
    componentDidMount(){
                ...
                <View style = { styles.box_text }>
                    ...
                    <View style ={styles.box_2}>
                        <View style = {styles.box_sub_21}>
                            <Text style ={{fontStyle:"italic", color:"black", fontWeight:"bold"}}>Số lượt đề cử: </Text>
                            <Text style = {{color:"#FF0033"}}>{String(this.props.value.number_rate)}</Text>
                        </View>
                        <View style = {styles.box_sub_21}>
